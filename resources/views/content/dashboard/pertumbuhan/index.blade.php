                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            <p><strong>Nama Balita:</strong>
                                {{ $item->nama_balita ?? 'Tidak diketahui' }}
                            </p>
                        </div>
                        <div class="col-md-6 mb-1">
                        ...
                        <div class="col-md-6 mb-1">
                            <p><strong>Jenis Kelamin:</strong>
                                {{ $item->jenis_kelamin === 'perempuan' ? 'Perempuan' : ($item->jenis_kelamin === 'laki-laki' ? 'Laki-Laki' : 'Tidak diketahui') }}
                            </p>
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            var options = {
                                ...
                                yaxis: {
                                    min: -4,
                                    max: 5, // Extended range to ensure annotation is visible
                                    labels: {
                                        formatter: function(value) {
                                            if (value > 3) {
                                                return "Tinggi";
                                ...
                                annotations: {
                                    xaxis: [{
                                        x: closestCategory, // Ensure this matches a value in categories
                                        borderColor: '#71DD37',
                                        strokeDashArray: 5,
                                        strokeWidth: 4,
                                        label: {
